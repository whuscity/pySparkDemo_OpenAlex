...
class OpenAlex():
  ...
  streams = {
    ...
    'InstitutionsGeo' : ('institutions_geo.tsv', ['institution_id:int', 'city:string?', 'geonames_city_id:string?', 'region:string?', 'country_code:string?', 'country:string?', 'latitude:float?', 'longitude:float?']),
    ...
    'WorksAlternateHostVenues' : ('works_alternate_host_venues.tsv', ['work_id:int', 'alternate_host_venue:int']),
