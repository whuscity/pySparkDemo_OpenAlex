...
class OpenAlex():
  ...
  streams = {
    ...
    'AuthorsIds' : ('authors_ids.tsv', ['author_id:string', 'openalex:string?', 'orcid:string?', 'scopus:string?', 'twitter:string?', 'wikipedia:string?', 'mag:int?']),
    ...
    'ConceptsIds' : ('concepts_ids.tsv', ['concept_id:string', 'openalex:string?', 'wikidata:string?', 'wikipedia:string?', 'umls_aui:string?', 'umls_cui:string', 'mag:int?']),
    ...
    'InstitutionsGeo' : ('institutions_geo.tsv', ['institution_id:string', 'city:string?', 'geonames_city_id:text?', 'region:string?', 'country_code:string?', 'country:string?', 'latitude:float?', 'longitude:float?']),
    'InstitutionsIds' : ('institutions_ids.tsv', ['institution_id:string', 'openalex:string?', 'ror:string?', 'grid:string?', 'wikipedia:string?', 'wikidata:string?', 'mag:int?']),
    ...
    'WorksAlternateHostVenues' : ('works_alternate_host_venues', ['work_id:string?', 'alternate_host_venue:string?']),
    ...
    'WorksIds' : ('works_ids.tsv', ['work_id:string', 'openalex:string?', 'doi:string?', 'mag:int?', 'pmid:string?']),
    ...
    'VenuesIds' : ('venues_ids.tsv', ['venue_id:string', 'openalex:string?', 'issn_l:string?', 'issn:string?', 'mag:int?'])
  }
